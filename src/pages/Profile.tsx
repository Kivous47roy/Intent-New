    ...
    <div className="flex flex-1 flex-col">
      ...
      <div className="px-6 pt-3">
        <div className="mb-3 flex items-baseline gap-3">
          <span className="font-mono text-[11px] uppercase tracking-[0.18em] text-ink-3">PROFILE</span>
          <div className="h-px flex-1 bg-ink/10" />
          <span className="font-mono text-[11px] text-ink-3">v1.0</span>
        </div>

        <div className="mt-2 flex items-center gap-4">
          <div className="flex h-16 w-16 items-center justify-center rounded-full border border-ink bg-paper-3">
            <span className="font-display text-[26px] italic">{initial}</span>
          </div>
          <div className="min-w-0">
            <input
              ...
              onBlur={onSaveAll}
              className="w-full bg-transparent font-display text-[26px] leading-[1.05] outline-none"
            />
      ...
      <div className="flex-1 px-6 pb-6 pt-5">
        <p className="mb-2 font-mono text-[10px] tracking-[0.12em] text-ink-3">── PRACTICE</p>
        <div className="mb-6 overflow-hidden rounded border border-line-strong bg-white/40">
          {[
            ...
            >
              <span className="text-[14px] text-ink-2">{row.l}</span>
              <span
                className="flex items-center gap-1.5 font-serif text-[16px] font-medium"
                style={{ color: row.accent ? "hsl(var(--accent))" : "hsl(var(--ink))" }}
              >
                {row.accent && <Flame className="h-3.5 w-3.5" />}
                {row.v}
              </span>
            </div>
          ))}
        ...
        <p className="mb-2 font-mono text-[10px] tracking-[0.12em] text-ink-3">── SETTINGS</p>
        <div className="overflow-hidden rounded border border-line-strong bg-white/40">
          ...
          >
            <span className="flex items-center gap-2 text-[14px]" style={{ color: "hsl(var(--accent))" }}>
        ...
        <p className="mt-7 text-center font-serif text-[13px] italic leading-[1.5] text-ink-3">
